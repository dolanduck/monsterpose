...
<div class="navbar navbar-default navbar-fixed-top">
 ...
 <input type="question-input" name="title" placeholder="Title">
 <textarea name="body" cols="30" rows="10" class="question" placeholder="Question"></textarea>
 <input type="submit" name="submit" value="Post question" class="question-btn">
 </form>
